...
class Site:
 ...
 def page(self,r,title,body):
  ...
  if r.user:auth=f'<a href="/area">La mia area</a><form method="post" action="/logout" class="inline">{r.csrf()}<button class="text-button">Esci</button></form>'
  elif self.ready:auth='<a href="/login">Accedi</a><a class="button small" href="/registrati">Paragrafo gratuito <span aria-hidden="true">↗</span></a>'
