...
class Site:
 ...
 def project_page(self,r,p):
  ...
  if admin:
   ...
   whatsapp_link=f'<a href="https://wa.me/{esc(student.get("whatsapp"))}?text={urllib.parse.quote("Ciao, ti contatto da FormaTesi in merito al tuo lavoro.")}" target="_blank" rel="noopener">Scrivi su WhatsApp ↗</a>' if student.get('whatsapp') else ''
